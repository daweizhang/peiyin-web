...
$(".chengshi li").click(function(){
	...
	var htlef5="<a href='javaScript:find8();' id='fsbbb'><div id='lseknmlkgsgg'><div id='fslekn1'><samp id='fegwvad'>Unconditional</samp></div></a></div>";
...
$(".chengshi1 li").click(function(){
	...
	var htle="<div id='fse2'><div id='lseknmlkgs'><div id='fslekn1'><samp id='fegwvad'>"+text2+"</samp></div>"
	   ...
	   var htlef5="<a href='javaScript:find8();'s id='fsbbb'><div id='lseknmlkgsgg'><div id='fslekn1'><samp id='fegwvad'>Unconditional</samp></div></a></div>";
