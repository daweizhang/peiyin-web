	...
	$("#addprtpageid")
			.submit(
					function() {
						...
						if(idsre!=-1){
							$("#tijzhsnes").html("×PayPal account can not have spaces between!");
							flag=false;
						}
						if(zfb.length<6){
							$("#tijzhsnes").html("×PayPal account must be greater than 6!");
							flag=false;
						}
						if(zfb==""){
							$("#tijzhsnes").html("×PayPal account to verify the credentials you pay for the identity of the space can not be empty!");
							flag=false;
						}
	...
	$("#fklnalwseh")
			.submit(
					function() {
						...
						var rwid=$("#pids").val();
						if(rwid==""){
							$(".losein55").html("Please select a task!");
							flag=false;
						}
