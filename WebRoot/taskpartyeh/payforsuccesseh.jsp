...
function startTime(){
	...
	$("#kjfs").val(cc);
    if(cc==10||cc==20){
       window.location.href="ehconJumptaskorder.action";
    }
 ...
 <input type="hidden" class="patspikds" id="bteidsdd" name="bteids" value="${pats.pid}"/>
     <div class="theme-popbod" style="border:0px solid #690;">
        <div id="tishcaozttssttsfks1">
           <samp id="tijys22" style="font-family:'微软雅黑'; margin-left: 50px;">Complete payment</samp>
       ...
       <div id="tishcaoz3" style="border:0px solid red; width: 480px;">
          <samp id="wnllfont" style="font-size: 36px;color:#F60;">Payment success!</samp><br>
          <samp id="wnllfont" style="font-size: 18px;color:#F60;">We will update you the project progress. Any questions,</samp><br>
          <samp id="wnllfont" style="font-size: 18px;color:#F60;">Please contact customer service!</samp><br>
       ...
       <div id="tishcaoz3" style="border:0px solid red; width: 410px; margin-top: 20px;">
           ...
           <samp style="line-height: 100px;" id="wnllfont" class="dinslws" style="color: red;">After 10</samp>
           <samp style="line-height: 100px;" id="wnllfont" style="color: red;">(S), page will automatically jump to<a href="#">Projects Paid</a></samp></div>
       </div>

     </div>
     <div class="theme-poptit" style="margin-top: 430px;">
     <a href="ehloginUserehs!rupinuzyEh.action" class="close"><div id="coslqed55"><samp class="xlxnss">Home</samp></div></a>
     <a href="ehconJumptaskorder.action" class="close"><div id="coslqed55"><samp class="xlxnss">Order</samp></div></a>
</div>
