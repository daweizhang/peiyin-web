...
<div id="void_nes1" style="border: 0px solid #ccc;   height: 780px;">
   ...
   <div id="mum_zhutiyi2" style="border:1px solid #ccc; height: 840px;">
          <div id="rele_fabu1">
              ...
              <div id="rele_fbnc2"><h4 id="rele_fndn1">Projects Paid</h4></div>
          </div>
          <div id="rele_fabu4">
             <table border="0" width="780" cellpadding="0" cellspacing="0">
                <tr height="36">
                   <td align="center" width="110" style="font-size: 14px;  color: #666;">Project Title</td>
                   <td align="center" width="60" style="font-size: 14px;  color: #666;">Price</td>
                   <td align="center" width="60" style="font-size: 14px;  color: #666;">Talent</td>
                   <td align="center" width="70" style="font-size: 14px;  color: #666;">Deal Time</td>
                   <td align="center" width="70" style="font-size: 14px;  color: #666;">Length</td>
          ...
          <c:forEach items="${podsu.items }" var="ptu">
             <div id="rele_uuc">
	              ...
	              <a href="javaScript:;" style="text-decoration: none; color: #636;">
	              <div id="rele_oo2" style="border:0px solid red;width: 106px;"><div class="rele_cso" style="color: red;">&nbsp;&nbsp;&nbsp;&nbsp;${ptu.ptotalprice/6 }0USD($)</div></div></a>
	              ...
	              <div id="rele_oo5" style="border:0px solid red;width: 111px;">
	                     <a href="ehpaymenthasbeenrw.action?menpid=${ptu.pid}&nspid=${ptu.pjbremail}"><input style="margin-top: 15px; width: 100px;" type='button' value='View orders' class='sfgkanss' id='sfgkan2'/></a>
	              </div>
             </div>
           </c:forEach>
          </div>
          <div id="rele_fabu6" style="height: 50px;">
            ...
            <div id="pageNav" style="border:0px solid red; width:780px; margin-left: 80px;"></div>
             ...
             <div style="margin-left: 330px;font-size: 16px;">No Paid Project!</div>
             </c:if>
            </div>
          </div>
   </div>
...
function showsub(id)
{
   window.location.href="ehconJumptaskorder.action?djyptu="+id;
}
  </script>
