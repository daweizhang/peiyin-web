...
<html>
  <head>
    ...
    <title>Wait for payment order</title>
...
<div id="void_nes1" style="border: 0px solid #ccc;   height: 780px;">
   ...
   <div id="mum_zhutiyi2" style="border:1px solid #ccc; height: 840px;">
          <div id="rele_fabu1">
              ...
              <div id="rele_fbnc2"><h4 id="rele_fndn1">List of Unpaid Projects</h4></div>
          </div>
          <div id="rele_fabu4">
             <table border="0" width="780" cellpadding="0" cellspacing="0">
                <tr height="36">
                   <td align="center" width="140" style="font-size: 14px;  color: #666;">Project Title</td>
                   <td align="center" width="70" style="font-size: 14px;  color: #666;">Price</td>
                   <td align="center" width="70" style="font-size: 14px;  color: #666;">Time</td>
                   <td align="center" width="80" style="font-size: 14px;  color: #666;">Talent ID</td>
          ...
          <c:forEach items="${pods.items}" var="pt">
             <div id="rele_uuc">
                  <a href="javaScript:;" style="text-decoration: none; color: #636;">
	              <div id="rele_oo1" style="border:0px solid red;width: 239px;"><div class="rele_cso" style="color: red;">${fn:substring(pt.btender.btName,0,25)}...</div></div>
	              </a>
	              <a href="javaScript:;" style="text-decoration: none; color: #636;">
	              <div id="rele_oo2" style="border:0px solid red;width: 120px;"><div class="rele_cso" style="color: red;">&nbsp;&nbsp;&nbsp;&nbsp;${pt.ptotalprice/6 }0USD($)</div></div></a>
	              <div id="rele_oo3" style="border:0px solid red;width: 120px;"><div class="rele_cso" style="margin-top: 0px;">&nbsp;${pt.pfqTime }</div></div>
	              <div id="rele_oo4" style="border:0px solid red;width: 143px;"><div class="rele_cso">&nbsp;&nbsp;${pt.puserId.iname }</div></div>
	              <div id="rele_oo5" style="border:0px solid red;width: 155px; text-align: center;">
	              <div style="margin-top: 12px;">
	                     
	                     <a href="ehConfirmation.action?pid=${pt.pid}&dyema=${djypt}"><input style="float: left; margin-left: 5px;border:1px solid #690;" type='button' onclick="" value='Re edit' class="sfgkanss33" id='sfgkan3'/></a>
	                     <a href="ehpaymento.action?uupid=${pt.pid}"><input style=" float: left; margin-left: 5px;border:1px solid #690;" type='button' onclick="" value='payment' class="sfgkanss33" id='sfgkan3'/></a>
	                      <%--<a href="ehdelepartpates!deleterwfoders.action?odserid=${pt.pid}"><input style=" float: left; margin-left: 45px;border:1px solid #690;" type='button' onclick="" value='Delete' class="sfgkanss33" id='sfgkan3'/></a> --%>
	              </div>
	              </div>
             </div>
             </c:forEach>
          ...
          <div id="rele_fabu6" style="height: 50px;">
            ...
            <div id="pageNav" style="border:0px solid red; width:780px; margin-left: 80px;"></div>
             ...
             <div style="margin-left: 330px;font-size: 16px;">No Unpaid Project!</div>
             </c:if>
            </div>
          </div>
   </div>
...
window.onload = (function(){
	...
	//重写分页状态,跳到第三页,总页33页
	if(parseInt('${djypt}')==0){
	   pageNav.go(parseInt('${djypt}'),'${pods.totalPageCount}');
	}else{
	   pageNav.go(parseInt('${djypt}'),'${pods.totalPageCount}');
	}
...
function showsub(id)
{
   window.location.href="ehunpaidtaskorder.action?djypt="+id;
}
