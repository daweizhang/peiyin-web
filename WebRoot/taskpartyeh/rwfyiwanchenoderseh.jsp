...
<div id="void_nes1" style="border: 0px solid #ccc;   height: 780px;">
   ...
   <div id="mum_zhutiyi2" style="border:1px solid #ccc; height: 840px;">
          <div id="rele_fabu1">
              ...
              <div id="rele_fbnc2"><h4 id="rele_fndn1">List of Completed Projects</h4></div>
          </div>
          <div id="rele_fabu4">
             <table border="0" width="780" cellpadding="0" cellspacing="0">
                <tr height="36">
                   ...
                   <td align="center" width="80" style="font-size: 14px;  color: #666;">Category</td>
                   <td align="center" width="70" style="font-size: 14px;  color: #666;">Price</td>
                   <td align="center" width="70" style="font-size: 14px;  color: #666;">Completed Time</td>
         ...
         <c:forEach items="${ywod.items }" var="yw">
             <div id="rele_uuc">
	              ...
	              <div id="rele_oo1" style="border:0px solid red;width: 239px;"><div class="rele_cso" style="color: red;">${fn:substring(yw.btender.btName,0,15)}...</div></div>
	              </a>
	              <a href="javaScript:;" style="text-decoration: none; color: #636;">
	              <div id="rele_oo4" style="border:0px solid red;width: 143px;"><div class="rele_cso">${yw.btender.tvoice.tts }</div></div>
	              <div id="rele_oo2" style="border:0px solid red;width: 120px;"><div class="rele_cso" style="color: red;">${yw.ptotalprice/6}0USD($)</div></div></a>
	              ...
	              <div id="rele_oo5" style="border:0px solid red;width: 155px; text-align: center;">
	                     <a href="ehpaymenthasbeenrw.action?menpid=${yw.pid}&nspid=${yw.pjbremail}" target="_blank"><input style="float: left; margin-top:15px; margin-left: 45px;border:1px solid #690;" type='button' onclick="" value='View task' class="sfgkanss33" id='sfgkan3'/></a>
	              </div>
             </div>
          ...
          <div id="rele_fabu6" style="height: 50px;">
            ...
            <c:if test="${ywod.totalCount==0}">
             ...
             <div style="margin-left: 230px;font-size: 16px;">No project completed!</div>
            </c:if>
            </div>
          </div>
   </div>
...
window.onload = (function(){
 ...
 function showsub(id)
{
   window.location.href="ehodersovers.action?ywodym="+id;
}
  </script>
