...
<div id="void_nes1" style="border: 0px solid #ccc;   height: 850px;">
   ...
   <form id="renwfupadtepaseh" action="ehloginUserehs!updatepasswordmmEh.action" method="post">
   <!-- 中间的内容DIV -->
   <div id="mum_zhutiyi2" style="border:1px solid #ccc;">
          <div id="rele_fabu1">
              ...
              <div id="rele_fbnc2"><h4 id="rele_fndn1">Change Password</h4></div>
          </div>
          <div id="rele_fabu2">
            ...
            <div id="fbrw_addl">
                 <table border="0" width="750" cellpadding="0" cellspacing="0">
                    <tr height="50">
                       <td width="150" align="right"><span style="color: red;">*</span><span class="fbrw_btii">Old Password：</span></td>
              ...
              <div id="fbrw_addl">
                 <table border="0" width="750" cellpadding="0" cellspacing="0">
                    <tr height="50">
                       <td width="150" align="right"><span style="color: red;">*</span><span class="fbrw_btii">New Password：</span></td>
              ...
              <div id="fbrw_addl">
                 <table border="0" width="750" cellpadding="0" cellspacing="0">
                    <tr height="50">
                       <td width="150" align="right"><span style="color: red;">*</span><span class="fbrw_btii">Confirm Password：</span></td>
