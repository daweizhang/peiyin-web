...
<!--D-->
    ...
    <div id="paihuang" style="margin-top: 5px;">
    	<div style="background-color:#FFC; margin:1%;">
    	    <div id ="info_id" style="margin-left:25%; margin-right:25%">
		    	<div style="font-size:28px;color:#660">
		    	...
		    	<br />
		    	<div style="color:#666">
		    		<span>11-31-7# SPB, Chongqing, 400000, China</span>
		    	</div>
		    	<br />
		    	<div style="color:red">
		    		<span>Phone:</span>
		    	...
		    	<br />
		        <div style="color:#666">
		    		<span>info@chinesevoiceoverfreelancers.com</span>
		    	</div>
            </div>

            <div class="article flns" style="margin-left:25%; margin-right:25%">
            	<samp id="slinwsjianyi1">You Can Also Msg Us Here</samp>
