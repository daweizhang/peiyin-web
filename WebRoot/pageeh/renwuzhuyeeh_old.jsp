		...
		<div id="void_nes1">
			...
			<div id="pyy_lsnls">
				<div class="selectbox">
					...
					<a href="loginUsers!findUserType.action" target="_blank" id='fsbbb'><div
							id="fabucon">
			...
			<div id="pyy_paixu">
				...
				<input id="doderbyid" type="hidden" value="1" /> <span id="ztscss">&nbsp;&nbsp;Per
					Page&nbsp;<span id="yemacss1"></span>&nbsp;
				</span> <span id="ztscss">Total&nbsp;<span id="yemacss2"></span>&nbsp;
				</span>
			...
			<div id="pyy_pyry">
				<div id="pyy_pyry1" style="border:0px solid red; width: 704px;">
					<div id="pyy_pyry3" style=" width: 704px;">
						<div class="pyy_pyry31" style=" width: 704px;">
					...
					<div id="pyy_pyry4" style=" width: 704px;">
						<div id="pageNav" style="width:650px;margin-top: 15px;"></div>
					</div>

				</div>
				<div id="pyy_pyry2" style="width: 290px;">
					<div class="pyy_pyry21" style="width: 290px;">
						<div class="pyy_pyry211" style="width: 290px;">
							<span class="pyy_pyry2112">Latest Projects</span>
						</div>
						<div class="pyy_pyry212"
							style="width: 275px; border:0px solid red;">
							<ul style="margin-left: -25px;">
								<li>ID: <a href="#">V658520</a> complete <a href="#">
										Test voice task </a><span> 05-21</span></li>
								<li>ID: <a href="#">V658520</a> complete <a href="#">
										Test voice task </a><span> 05-21</span></li>
								<li>ID: <a href="#">V658520</a> complete <a href="#">
										Test voice task </a><span> 05-21</span></li>
					...
					<div class="pyy_pyry22">
						<img alt="" src="images/rewnuzy.png" width="290" height="422">
					</div>
				</div>
