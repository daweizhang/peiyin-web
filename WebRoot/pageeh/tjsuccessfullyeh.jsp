...
<html>
  <head>
    ...
    <title>Finished product submission</title>
...
<div class="theme-popover" style="height: 310px; margin-top: -110px; display: block; z-index: 998;">
 <input type="hidden" id="bteidsdd" name="bteids" value="${cpid }"/>
     <div class="theme-popbod" style="border:0px solid #690;">
        <div id="tishcaozttss">
           <samp id="tijys22" style="font-family:'微软雅黑';">提示</samp>
        ...
        <div id="tishcaoz2">
            <div id="tishitup1"><samp class="duitub5">√</samp></div>
            <div id="tishitup2"><samp class="bsexs12">&nbsp;&nbsp;&nbsp;成品提交成功!审核中...</samp></div>
            <div id="tishitup3"><samp class="bsexs1" id="blxllw" style="font-size: 15px;font-weight: bold;color: red;">5</samp><samp class="bsexs1">秒后自动返回!</samp></div>

       </div>
     </div>
     <div class="theme-poptit" style="margin-top: 110px;"><a href="delepartpates!findSubmitproduct.action?cpid=${cpid}" class="close"><div id="coslqed55"><samp class="xlxnss">返回</samp></div></a>
...
function startTime(){
	...
	var pobd=$("#bteidsdd").val();
	   window.location.href="delepartpates!findSubmitproduct.action?cpid="+pobd+"";
	}
	$("#kjfs").val(cc);
