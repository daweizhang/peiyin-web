...
<html>
  ...
  <body> 
	<div class="bjui-pageHeader">
		<form id="pagerForm" data-toggle="ajaxsearch" action="messtons.action" method="post">
			<input type="hidden" name="pageCurrent">
      		<input type="hidden" name="pageSize" >
       	 	<input type="hidden" name="orderField">
       <div class="bjui-searchBar">
       <br>
            <label>客户账户：</label><input type="text" name="khuser" class="form-control" size="20" value="${khuser }" >&nbsp;
            <label>消息关键字：</label><input type="text" name="gjzName" class="form-control" size="20" value="${gjzName }" >&nbsp;
        ...
        <thead>
            <tr height="35px" >
				...
				<th width="70" align="center">客户类型</th>
            	<th width="70" align="center">客户账户</th>
            	<th width="70" align="center">消息内容</th>
                <th width="70" align="center">发送时间</th>
                <th width="70" align="center">发送者</th>
                <!-- <th width="100" align="center">操作</th>
                   -->
            </tr>
        </thead>
                       <%-- <fmt:formatDate value="${prodt.MUpdateTime }" pattern="yyyy-MM-dd hh:mm:ss"/> --%>
        <c:forEach  items="${pms.items}" var="m">
        		<tr><!--  data-id="${item.MId}" id="adid" -->
        			<td align="center"><input type="checkbox" class="checkboxCtrl" name="product_id" data-toggle="icheck" value="${m.mid}"></td>
					<td align="center">${m.mrole }</td>
					<td align="center">${m.messagesender }</td>
					<td align="center">${m.messagecontent }</td>
					<td align="center">${m.mdatesent }</td>
					<c:if test="${m.mspareyi=='1' }">
					   <td align="center">客户消息</td>
					</c:if>
					<c:if test="${m.mspareyi=='2' }">
					   <td align="center">客服消息</td>
					</c:if>
					<!-- <td align="center">
    ...
    <div class="pages">
        ...
        <span>&nbsp;条，共${pms.totalCount }条</span>
    </div>
    <div class="pagination-box" data-toggle="pagination" data-total="${pms.totalCount}" data-page-size="${pms.pageSize}" data-page-current="${pms.currPageNo}"></div>
</div>
</body>
