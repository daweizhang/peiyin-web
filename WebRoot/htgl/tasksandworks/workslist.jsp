...
<html>
  ...
  <body> 
	<div class="bjui-pageHeader">
       ...
       <br>
            <label>作品名称：</label><input type="text" name="plsddh" class="form-control" size="20" value="" >&nbsp;
            <label>发布人账户 ：</label><input type="text" name="fkaccnt" class="form-control" size="20" value="" >&nbsp;
        ...
        <c:forEach  items="${poders.items}" var="ors">
        		<tr><!--  data-id="${item.MId}" id="adid" -->
					...
					<td align="center">fasdf</td>
					<td align="center">asdfas</td>
					<td align="center">fasdf</td>
					<td align="center">asdfas</td>
					<td align="center">fasdfasf</td>
					<td align="center">asdfasdf</td>
					<td align="center">asdfasdf</td>
					<td align="center">
