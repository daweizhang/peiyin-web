...
<html>
  ...
  <body>
  <h3 style="margin-top: 20px;">国外任务</h3></div>
  	...
  	<form  method="post" id="addchannelseekForm" action="updatetaksdd.action" class="pageForm" data-toggle="ajaxform" >
    	<table class="info-type-table" border="0">
    		...
    		<tr>
    			...
    			<td>
    				<input type="text" placeholder="" size="25" id="taginfoname" value="${bt.btName }" readonly="readonly">
    			</td>
    		...
    		<tr>
    			...
    			<td>
    				<input type="text" placeholder="" size="25" id="taginfoname" value="${bt.bprice/6}$(USD)==${bt.bprice}￥(RMB)" readonly="readonly">
    			</td>
    			<td align="right"><label style="width:100px;">稿文字数：</label></td>
    			<td align="center">
    				<input type="text" placeholder="" size="25" id="taginfoname" value="${bt.basofTime }(单词)" readonly="readonly">
    			</td>
    		</tr>
    		<tr>
    		...
    		<tr>
    			<td align="right"><label style="width:100px;">任务试音：</label></td>
    			<td colspan="3">
    				<textarea rows="" cols="" style="width: 600px; height: 100px;" readonly="readonly">${bt.bpygaowen }</textarea>
    			</td>
    		...
    		<tr>
    			...
    			<td colspan="3">
    				<textarea rows="" cols="" style="width: 600px; height: 100px;" readonly="readonly">${bt.bxxmiaoshu }</textarea>
    			</td>
    			
    		</tr>
    		<tr>
    			<td align="right"><label style="width:100px;">正式稿文是否需要翻译?：</label></td>
    			<td colspan="3">
    			<c:if test="${bt.bsffy=='205' }">
    				<input type="text" placeholder="" size="25" id="taginfoname" value="不需要" readonly="readonly">
    				</c:if>
    				<c:if test="${bt.bsffy=='208' }">
    				<input type="text" placeholder="" size="25" id="taginfoname" value="需要" readonly="readonly">
    				</c:if>
    			</td>
    			</td>
    	...
    	<table class="info-type-table" border="0" style="float: right; position: absolute; top:50px; right: 50px;">
    		<tr height="25px;">
    			<td align="left" colspan="2">(英文翻译中文)翻译后的字段(可修改翻译后的字段)</td>
    		</tr>
    		<input type="hidden" name="bfid" value="${bt.bftranslate.bfid}">
    		<tr>
    			<td align="right"><label style="width:100px;">任务标题(翻译后)：</label></td>
    			<td>
    				<input type="text" placeholder="" name="bfs.bfNames" size="25" id="taginfoname" value="${bt.bftranslate.bfNames }">
    			</td>
    		...
    		<tr>
    			...
    			<td>
    				<textarea rows="" cols="" name="bfs.bfsygw" style="width:300px; height: 200px;">${bt.bftranslate.bfsygw }</textarea>
    			</td>
    		...
    		<tr>
    			...
    			<td>
    				<textarea rows="" cols="" name="bfs.bftiser" style="width:300px; height: 200px;">${bt.bftranslate.bftiser }</textarea>
    			</td>
