...
<html>
  ...
  <body>
  <img alt="" src="upload/${is.iportrait }" width="100" height="100" style="float: left;"><h3 style="margin-top: 20px;">任务方资料</h3></div>
  	...
  	<form  method="post" id="addchannelseekForm" action="OrdersPendid!findupdateorder.action" class="pageForm" data-toggle="ajaxform" >
    	<table class="info-type-table" border="0">
    		...
    		<tr>
    			...
    			<td align="right"><label style="width:100px;">公司名称：</label></td>
    			<td align="center">
    				<input type="text" placeholder="" size="25" id="taginfoname" value="${is.igName}" readonly="readonly">
    			</td>
    		</tr>
    		<tr>
    			<td align="right"><label style="width:100px;">公司详细地址：</label></td>
    			<td>
    				<input type="text" placeholder="" size="25" id="taginfoname" value="${is.igDetailed}" readonly="readonly">
    			</td>
    			<td align="right"><label style="width:100px;">公司法人：</label></td>
    			<td align="center">
    				<input type="text" placeholder="" size="25" id="taginfoname" value="${is.igPerson}" readonly="readonly">
    			</td>
    		</tr>
