...
$(function(){
  ...
  <body>
    <div class="login-box">
	<h1>国际配音系统后台登录</h1>
	<form method="post" action="isadlogin!loginAisadmin.action">
		<dvi>
			<p  style="margin-top:10px;color:red;font-size:14px;">${requestScope.resultMessage}</p>
		</dvi>
		<div class="name">
			<label>管理员账号：</label>
			<input type="text" name="aisadmin.aisadmName" id="" tabindex="1" autocomplete="off" />
		</div>
		<div class="password">
			<label>密  码：</label>
			<input type="password" name="aisadmin.aisadpassword" maxlength="16" id="" tabindex="2"/>
		</div>
		<!--<div class="code" style="border:1px solid red;">
			<label>验证码：</label>
		...
		<div class="remember">
			...
			<label>记住密码</label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="fasf.html" style="text-decoration:none; color:red;"><label>忘了密码</label></a>
		</div>
		<div class="login">
