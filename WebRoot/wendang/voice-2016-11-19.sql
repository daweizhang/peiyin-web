...
INSERT INTO `a_isadmin` VALUES ('afdasfasberae', 'admincom', '3d414ff33b056f2b', '管理员', null, '男', '969353498@qq.com', '15213478863', '2016-5-5 00:00:00', '2016-11-21 20:31:56', null, '0:0:0:0:0:0:0:1', '1', 'null', 'null', 'null');
...
-- ----------------------------
INSERT INTO `bf_translate` VALUES ('402881e5587787810158778e697b0003', '一个测试任务', '一个正在测试的任务了一个正在测试的任务了一个正在测试的任务了一个正在测试的任务了一个正在测试的任务了一个正在测试的任务了一个正在测试的任务了一个正在测试的任务了一个正在测试的任务了', null, 'DF18399120161118210931931713118', '一个正在测试的任务了一个正在测试的任务了一个正在测试的任务了一个正在测试的任务了一个正在测试的任务了一个正在测试的任务了');
INSERT INTO `bf_translate` VALUES ('402881e5587838370158784be4e80000', 'fasdasdfasdfasdf', '我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三我叫张三', null, 'DF212916201611190036293629281142', '我叫张三');
INSERT INTO `bf_translate` VALUES ('402881e65886dcf0015886def8dd0001', 'sdfsdfasfadf', '一个测试任务一个测试任务一个测试任务一个测试任务一个测试任务一个测试任务一个测试任务一个测试任务一个测试任务一个测试任务一个测试任务一个测试任务', null, 'DF1080534201611212031493149743310', '一个测试任务一个测试任务一个测试任务一个测试任务一个测试任务一个测试任务一个测试任务一个测试任务');
INSERT INTO `bf_translate` VALUES ('402881e758ab27e80158ab3934710001', 'gdsgsd sgdfg', 'gdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfg', '空空', 'DF729887201611282156425642729292', 'gdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfg');
...
-- Records of b_tender
-- ----------------------------
INSERT INTO `b_tender` VALUES ('402881e65886dcf0015886def8ed0002', 'sdfsdfasfadf', '2016-11-21 20:31:47', 'chenchao1', 'baerawvaecaeade', '523456rgbdfseg', '2016-11-21-20-31-47-3147699573c4ec4e74ef004d5e54333ba80ff3975aceshi.mp3', '男', 'b00984534yvsdgfva', '', 'A test task a test task a test task a test task a test task a test task a test task a test task a test task a test task a test task a test task', '2016-11-21-20-31-47-3147711915cef2801266281a8ac407499a2cc9f073ttttt.docx', 'A test task a test task a test task a test task a test task a test task a test task a test task', '500', '500', 'baefaf758eaecc', '2', '3g56a6sdgs65ed6v5d0005', 'as648se5br5d5s24s5dx001', '0', null, '222', '402881e65886dcf0015886def8dd0001', '1', '12');
INSERT INTO `b_tender` VALUES ('402881e758ab27e80158ab39347e0002', 'gdsgsd sgdfg', '2016-11-28 21:56:40', 'ccadmincc', 'baerawvaecaeade', '523456rgbdfseg', '2016-11-28-21-56-39-5639613417052dc83b9aaad74d8a5bcf790f9fc698jbshiyin.mp3', 'male', 'easheraveaeAgse', 'nullnull', 'gdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfg', '2016-11-28-21-56-39-5639811211fb869d57b578c58f6e4d68994e225e86ttttt.docx', 'gdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfggdsgsd sgdfg', '50', '348', 'bratqaefabasfa', '0', '3g56a6sdgs65ed6v5d0004', 'as648se5br5d5s24s5dx002', '0', '205', '111', '402881e758ab27e80158ab3934710001', '0', '1');
...
INSERT INTO `h_speed` VALUES ('as648se5br5d5s24s5dx003fas', '不限', 'Not limited');
...
-- ----------------------------
INSERT INTO `if_ehuser` VALUES ('402881e5587787810158778c2da90001', 'male', 'Korea - Daegu Metropolitan City', 'Wu♫Cantonese♫Taiwanese♫Xiang♫Hakka', 'Documentaries♫Cartoons♫E-Learning', 'Amusing/Funny♫Conversational/Natural♫Child/Teenager', '1-5 years', 'chenchao');
INSERT INTO `if_ehuser` VALUES ('402881e65886dcf0015886e07b2d0004', 'male', 'China - Beijing', 'Cantonese♫Wu♫Xiang', 'Audiobooks♫Cartoons♫E-Learning', 'Power/Energetic♫Conversational/Natural♫Epic/Classy', '1-5 years', 'xiaochao');
...
CREATE TABLE `inusers` (
  ...
  `I_scoced` int(50) DEFAULT NULL COMMENT '交易次数',
  PRIMARY KEY (`I_ID`),
...
-- Records of inusers
-- ----------------------------
INSERT INTO `inusers` VALUES ('402881e65881ce13015881f5590d0000', 'chenchao', 'a57cee6498dbec9a066daccaa262e982', 'V234312', 'txtub.png', null, null, null, null, null, '969353498@qq.com', null, null, '2016-11-20 21:38:09', null, null, '0', '0', null, null, null, null, 'berwartaedfeee', '0', null, null, '0');
INSERT INTO `inusers` VALUES ('402881e65886dcf0015886ddbec10000', 'chenchao1', 'a57cee6498dbec9a364861754689eb00', 'C72038', 'renwuf.png', '男', '', '', '', '', '969353498@qq.com', '15213478863', '中国-吉林', '2016-11-21 20:30:29', null, null, '0', '0', null, null, null, null, 'gseaeffasdasc', '0', null, null, '0');
INSERT INTO `inusers` VALUES ('402881e65886dcf0015886dfddf90003', 'xiaochao', '833e874c686b10fa066daccaa262e982', 'V393385', 'txtub.png', '男', '2016-11-10', null, null, null, '969353498@qq.com', '15213478863', '中国-北京市', '2016-11-21 20:32:48', null, null, '0', '0', 'brarabas32fsdf', '粤语♫吴语♫湘语', '电子书♫卡通♫教育/教学', '激昂高亢♫自然亲和♫浑厚大气', 'berwartaedfeee', '0', '1-5年', '402881e65886dcf0015886e07b2d0004', '0');
INSERT INTO `inusers` VALUES ('402881e758ab27e80158ab369fca0000', 'ccadmincc', '0db4ba93530764fa4aafa0206d589a90', 'C26375', 'renwuf.png', 'male', '', '', '', '', '969353498@qq.com', '15213478863', 'France-普瓦图-夏朗德 Poitou-Charentes', '2016-11-28 21:53:53', null, null, '0', '0', null, null, null, null, 'gseaeffasdasc', '0', null, null, null);
INSERT INTO `inusers` VALUES ('402881e758ab27e80158ab6a0a9c0003', 'laochao123', '8eed964c8317b6f732beb9ecf94a37e7', 'V505496', 'txtub.png', null, null, null, null, null, '847078739@qq.com', null, null, '2016-11-28 22:50:03', null, null, '0', '0', null, null, null, null, 'berwartaedfeee', '0', null, null, '0');
...
INSERT INTO `l_gtype` VALUES ('veag3232fafecedx4', '中式英语', 'English with Chinese accent');
INSERT INTO `l_gtype` VALUES ('veasgaefafecaec', '客家话', 'Hakka');
INSERT INTO `l_gtype` VALUES ('veasgaefafecedx4', '闽语', 'Min');
INSERT INTO `l_gtype` VALUES ('veasgagew2323c', '其他', 'other');
...
CREATE TABLE `p_artpate` (
  ...
  `P_whetherscore` varchar(50) DEFAULT NULL COMMENT '是否评分',
  `P_scorect` varchar(50) DEFAULT NULL COMMENT '分数',
  PRIMARY KEY (`P_ID`),
...
-- ----------------------------
INSERT INTO `p_artpate` VALUES ('402881e65886dcf0015886e0bc6f0005', '402881e65886dcf0015886dfddf90003', 'chenchao1', '402881e65886dcf0015886def8ed0002', '2016-11-21 20:33:40', null, 'baseecasef', '800', null, null, null, null, null, null, null, '133.33', null, null, null, null, null, null, 'IDC720382016-11-21-20-33-45-3345Audiotest.mp3', null, null, 'vbflkenlkbdklrmv2240', null, null, '110', '0');
...
INSERT INTO `s_crowd` VALUES ('brarabfase324500fsdf', '上海 ', 'Shanghai ');
...
INSERT INTO `s_crowd` VALUES ('rh23450gasdr423dg23', '江苏 ', 'Jiangsu');
INSERT INTO `s_crowd` VALUES ('rhabab3423453dg', '天津 ', 'Tianjin');
INSERT INTO `s_crowd` VALUES ('rhabbsdr34343453dg', '台湾', 'Taiwan');
INSERT INTO `s_crowd` VALUES ('rhabsdf342s34hhah', '甘肃', 'Gansu ');
INSERT INTO `s_crowd` VALUES ('rhaefae322fsDfasdg', '澳门', 'Macao');
...
INSERT INTO `s_crowd` VALUES ('sbnd34egfasg4fasdg23', '无', 'Unlimited');
...
INSERT INTO `t_voice` VALUES ('basehagse3244', '歌唱', 'Sing');
INSERT INTO `t_voice` VALUES ('basehe3264356', '其他', 'other');
...
INSERT INTO `y_syleix` VALUES ('sga234svgbesav3', '故事旁白', 'Storyteller');
...
INSERT INTO `y_syleix` VALUES ('sgavefasvgbesav3', '其他风格', 'Other');
