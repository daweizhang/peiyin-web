...
<div id="void_nes1" style="border: 0px solid #ccc;   height: 780px;">
   <div id="mum_zhutiyi1">
      <ul id="mum_ul_s">
        ...
        <li id="mum_lncs1" class="mum_licss3"><a style="color: #690;" class="mum_asccss" href="conJumptaskorder.action">已付款任务订单</a></li>
   ...
   <div id="mum_zhutiyi2" style="border:1px solid #ccc; height: 840px;">
          <div id="rele_fabu1">
              ...
              <div id="rele_fbnc2"><h4 id="rele_fndn1">已付款任务订单列表</h4></div>
          </div>
          <div id="rele_fabu4">
             <table border="0" width="780" cellpadding="0" cellspacing="0">
                <tr height="36">
                   ...
                   <td align="center" width="60" style="font-size: 14px;  color: #666;">配音员昵称</td>
                   <td align="center" width="70" style="font-size: 14px;  color: #666;">合作时间</td>
                   <td align="center" width="70" style="font-size: 14px;  color: #666;">时间范围</td>
          ...
          <c:forEach items="${podsu.items }" var="ptu">
             <div id="rele_uuc">
                  <a href="javaScript:;" style="text-decoration: none; color: #636;">
	              <div id="rele_oo1" style="border:0px solid red;width: 191px;"><div class="rele_cso" style="color: red;">${fn:substring(ptu.btender.btName,0,20)}...</div></div>
	              </a>
	              <a href="javaScript:;" style="text-decoration: none; color: #636;">
	              <div id="rele_oo2" style="border:0px solid red;width: 106px;"><div class="rele_cso" style="color: red;">&nbsp;&nbsp;&nbsp;&nbsp;${ptu.ptotalprice }.00USD($)</div></div></a>
	              <div id="rele_oo3" style="border:0px solid red;width: 106px;"><div class="rele_cso">&nbsp;&nbsp;${ptu.puserId.iname }</div></div>
	              <div id="rele_oo4" style="border:0px solid red;width: 131px;"><div class="rele_cso" style="margin-top: 0px;">${ptu.pfkTime}</div></div>
	              <div id="rele_oo6" style="border:0px solid red;width: 131px;"><div class="rele_cso" style="margin-top: 0px;">${ptu.ptimelimit}(hour)</div></div>
	              <div id="rele_oo5" style="border:0px solid red;width: 111px;">
	                     <a href="paymenthasbeenrw.action?menpid=${ptu.pid}&nspid=${ptu.pjbremail}"><input style="margin-top: 15px;" type='button' value='查看订单' class='sfgkanss' id='sfgkan2'/></a>
	              </div>
             </div>
           </c:forEach>
          </div>
          <div id="rele_fabu6" style="height: 50px;">
            ...
            <div id="pageNav" style="border:0px solid red; width:780px; margin-left: 80px;"></div>
             ...
             <div style="margin-left: 330px;font-size: 16px;">暂无已付款订单！</div>
             </c:if>
            </div>
          </div>
   </div>
...
window.onload = (function(){
	...
	//重写分页状态,跳到第三页,总页33页
	if(parseInt('${djyptu}')==0){
	   pageNav.go(parseInt('${djyptu}'),'${podsu.totalPageCount}');
	}else{
	   pageNav.go(parseInt('${djyptu}'),'${podsu.totalPageCount}');
	}
...
function showsub(id)
{
   window.location.href="conJumptaskorder.action?djyptu="+id;
}
  </script>
