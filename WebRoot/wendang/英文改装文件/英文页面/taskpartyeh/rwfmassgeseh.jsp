...
<div id="void_nes1" style="border: 0px solid #ccc;   height: 780px;">
   <div id="mum_zhutiyi1">
      <ul id="mum_ul_s">
        ...
        <li id="mum_lncs1" class="mum_licss3"><a style="color: #690;" class="mum_asccss" href="usersystemnews.action">系统消息</a></li>
   ...
   <div id="mum_zhutiyi2" style="border:1px solid #ccc; height: 840px;">
          <div id="rele_fabu1">
              ...
              <div id="rele_fbnc2" style="margin-left: 3px;"><h4 id="rele_fndn1">系统消息</h4></div>
          </div>
          <div id="rele_fabu4">
             <table border="0" width="780" cellpadding="0" cellspacing="0">
                <tr height="36">
                   <td align="center" width="140" style="font-size: 14px;  color: #666;">标题</td>
                   <td align="center" width="80" style="font-size: 14px;  color: #666;">消息类型</td>
                   <td align="center" width="70" style="font-size: 14px;  color: #666;">查看状态</td>
                   <td align="center" width="70" style="font-size: 14px;  color: #666;">发送时间</td>
           ...
           <c:forEach items="${listnews.items }" var="nes">
             <div id="rele_uuc" <c:if test="${nes.xmessagestatus=='200'}">style="font-weight: bold;"</c:if>>
	              ...
	              <div id="rele_oo5" style="border:0px solid red;width: 155px; text-align: center;">
	                     <a href="delepartpates!Seethemessage.action?newsid=${nes.xid}&nzym=${newsym}" target="_blank"><input style="float: left; margin-top:15px; margin-left: 45px;border:1px solid #690;" type='button' onclick="" value='查看消息' class="sfgkanss33" id='sfgkan3'/></a>
	              </div>
             </div>
           </c:forEach>
          ...
          <div id="rele_fabu6" style="height: 50px;">
            ...
            <c:if test="${listnews.totalCount==0}">
             ...
             <div style="margin-left: 330px;font-size: 16px;">暂无系统消息！</div>
            </c:if>
            </div>
          </div>
   </div>
...
window.onload = (function(){
 ...
 function showsub(id)
{
   window.location.href="usersystemnews.action?newsym="+id;
}
  </script>
