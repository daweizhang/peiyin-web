          ...
          <div id="rele_fabu2" >
            <form action="userupdate.action" method="post" name="fromuserzl">
              ...
              <div id="fbrw_addl">
                 <table border="0" width="750" cellpadding="0" cellspacing="0">
                    <tr height="50">
                       ...
                       <td width="370" style="font-size: 14px;"><input type="text" name="userrwf.iname" class="fbrw_libit6" value="${ius.iname}" readonly="readonly"></td>
              ...
              <div id="fbrw_addl">
                 <table border="0" width="750" cellpadding="0" cellspacing="0">
                    <tr height="50">
                       <td width="150" align="right"><span style="color: red;">*</span><span class="fbrw_btii">用户性别：</span></td>
                       <td width="370" style="font-size: 14px;">

                             <div style="float: left;">
                             <input type="text" name="userrwf.isex" class="fbrw_libit3" id="clklieshow" value="${ius.isex }"/></div>
              ...
              <div id="fbrw_addl">
                  <table border="0" width="750" cellpadding="0" cellspacing="0">
                    <tr height="50">
                       <td width="150" align="right"><span style="color: red;">*</span><span class="fbrw_btii">公司名称：</span></td>
                       <td width="570" style="font-size: 14px;">
                       <input type="text" name="userrwf.igName"  value="${ius.igName }" class="fbrw_libit6"/>
                       </td>
              ...
              <div id="fbrw_addl">
                  <table border="0" width="750" cellpadding="0" cellspacing="0">
                    <tr height="50">
                       <td width="150" align="right"><span style="color: red;">*</span><span class="fbrw_btii">创建人：</span></td>
                       <td width="570" style="font-size: 14px;">
                       <input type="text" name="userrwf.igPerson" value="${ius.igPerson }" class="fbrw_libit6"/>
                       </td>
                       <td width="18"><span style="font-size:14px; color: #666;"></span></td>
                    </tr>
                 </table>
              ...
              <div id="fbrw_addl">
                 <table border="0" width="750" cellpadding="0" cellspacing="0">
                    <tr height="50">
                       <td width="150" align="right"><span style="color: red;">*</span><span class="fbrw_btii">创建日期：</span></td>
                       <td width="370" style="font-size: 14px;">
              ...
              <div id="fbrw_addl">
                  <table border="0" width="750" cellpadding="0" cellspacing="0">
                    <tr height="50">
                       <td width="150" align="right"><span style="color: red;">*</span><span class="fbrw_btii">公司地区：</span></td>
                       <td width="570" style="font-size: 14px;">
                       <input type="text" name="userrwf.iregion" id="klnklvnse" value="${ius.iregion }" class="fbrw_libit6"/>
                       </td>
                       <td width="18"><span style="font-size:14px; color: #666;"></span></td>
                    </tr>
                 </table>
              ...
              <div id="fbrw_addl">
                  <table border="0" width="750" cellpadding="0" cellspacing="0">
                    <tr height="50">
                       <td width="150" align="right"><span style="color: red;">*</span><span class="fbrw_btii">详细地址：</span></td>
                       <td width="570" style="font-size: 14px;">
                       <input type="text" name="userrwf.igDetailed" id="klnklvnse" value="${ius.igDetailed }" class="fbrw_libit6"/>
                       </td>
                       <td width="18"><span style="font-size:14px; color: #666;"></span></td>
                    </tr>
                 </table>
              ...
              <div id="fbrw_addl">
                <table border="0" width="750" cellpadding="0" cellspacing="0">
                    <tr height="50">
                       ...
                       <td width="370" style="font-size: 14px;"><input type="text" name="userrwf.iphone" class="fbrw_libit6" value="${ius.iphone }"></td>
                       <td width="218"><span style="font-size:14px; color: #666;"></span></td>
                    </tr>
                 </table>
