 ...
 <input type="hidden" class="patspikds" id="bteidsdd" name="bteids" value="${pats.pid}"/>
     <div class="theme-popbod" style="border:0px solid #690;">
        <div id="tishcaozttssttsfk">
           <samp id="tijys22" style="font-family:'微软雅黑'; margin-left: 50px;">Confirm the payment</samp>
       ...
       <div id="tishcaoz3" style="border:0px solid red; width: 480px;">
          <samp id="wnllfont" style="font-size: 15px;color:#660;"><samp style="color: #999; font-size: 15px;">The order number:</samp>${pats.ptemporaryid}</samp><br>
          <samp id="wnllfont" style="font-size: 15px; color:#660;"><samp style="color: #999; font-size: 15px;">Task Name:</samp>${pats.btender.btName }</samp><br>
          <samp id="wnllfont" style="color: red;"><samp style="color: #999;">Pay the amount:</samp>${pats.ptotalprice}.00USD($)</samp>
       </div>
       
        <div id="tishcaoz3" style="border:0px solid red; width: 480px;">
          <samp id="wnllfont" style="color: red;"><samp style="color: #999;">Payment account:</samp>lediali@163.com</samp><br>
          <samp id="wnllfont" style="color: red; font-size: 14px;"><samp style="color: #999;">Warm prompt:</samp>
          The account for Paypal platform account, is this website payment account! The time of payment, please carefully check account! Such as pay error, this website is not responsible for the.
          </samp>
       </div>
       <div id="tishcaoz3" style="border:0px solid red; width: 480px;">
       ...
       <div id="tishcaoz3" style="border:0px solid red; width: 480px; margin-top: 10px;">
          <samp id="wnllfont" style="color: red; font-size: 16px;"><samp style="color: #999;">The first step:</samp>
             If you have already payment, please send the temporary order number to the personnel of the service!<a href="#" style="text-decoration: underline;">Click on sendfor</a>
          </samp><br>
       </div>
       <div id="tishcaoz3" style="border:0px solid red; width: 480px; margin-top: 10px;">
          <samp id="wnllfont" style="color: red; font-size: 16px;"><samp style="color: #999;">The third step:</samp>
             Customer service confirm time was 600 seconds, please be patient, after the success of the system to confirm payment page will automatically jump...
          </samp><br>
       </div>
