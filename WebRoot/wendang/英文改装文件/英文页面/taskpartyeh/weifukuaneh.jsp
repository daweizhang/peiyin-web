...
<div id="void_nes1" style="border: 0px solid #ccc;   height: 780px;">
   <div id="mum_zhutiyi1">
      <ul id="mum_ul_s">
        ...
        <li id="mum_lncs1" class="mum_licss3"><a style="color: #690;" class="mum_asccss" href="unpaidtaskorder.action">待付款任务订单</a></li>
   ...
   <div id="mum_zhutiyi2" style="border:1px solid #ccc; height: 840px;">
          <div id="rele_fabu1">
              ...
              <div id="rele_fbnc2"><h4 id="rele_fndn1">未付款任务订单列表</h4></div>
          </div>
          <div id="rele_fabu4">
             <table border="0" width="780" cellpadding="0" cellspacing="0">
                <tr height="36">
                   <td align="center" width="140" style="font-size: 14px;  color: #666;">任务名称</td>
                   <td align="center" width="70" style="font-size: 14px;  color: #666;">支付金额</td>
                   <td align="center" width="70" style="font-size: 14px;  color: #666;">订单发起时间</td>
                   <td align="center" width="80" style="font-size: 14px;  color: #666;">配音员昵称</td>
          ...
          <c:forEach items="${pods.items}" var="pt">
             <div id="rele_uuc">
	              ...
	              <a href="javaScript:;" style="text-decoration: none; color: #636;">
	              <div id="rele_oo2" style="border:0px solid red;width: 120px;"><div class="rele_cso" style="color: red;">&nbsp;&nbsp;&nbsp;&nbsp;${pt.ptotalprice }.00USD($)</div></div></a>
	              ...
	              <div id="rele_oo5" style="border:0px solid red;width: 155px; text-align: center;">
	                     <a href="Confirmation.action?pid=${pt.pid}&dyema=${djypt}"><input style="float: left; margin-left: 5px;border:1px solid #690;" type='button' onclick="" value='重新编辑' class="sfgkanss33" id='sfgkan3'/></a>
	                     <a href="paymento.action?uupid=${pt.pid}"><input style=" float: left; margin-left: 5px;border:1px solid #690;" type='button' onclick="" value='立即付款' class="sfgkanss33" id='sfgkan3'/></a>
	                     <a href="delepartpates!deleterwfoders.action?odserid=${pt.pid}"><input style=" float: left; margin-left: 45px;border:1px solid #690;" type='button' onclick="" value='删除订单' class="sfgkanss33" id='sfgkan3'/></a>
	              </div>
             </div>
             </c:forEach>
          </div>
          <div id="rele_fabu6" style="height: 50px;">
            ...
            <div id="pageNav" style="border:0px solid red; width:780px; margin-left: 80px;"></div>
             ...
             <div style="margin-left: 330px;font-size: 16px;">暂无待付款订单！</div>
             </c:if>
            </div>
          </div>
   </div>
...
function showsub(id)
{
   window.location.href="unpaidtaskorder.action?djypt="+id;
}
