      ...
      <form id="backpsdfrom" name="form1" method="post" action="loginUsers!findUserii">
        <table width="975" height="200" border="0">
          ...
          <tr height="40">
            ...
            <td id="gets_ts" width="554"><span id="regesjs2" style="color:#aaa">*用户名为必填项，填写你要找回的用户名！</span></td>
          </tr>
         <tr height="40">
             <td width="192" align="right"><samp style="font-size: 16px; color:#660;">*绑定的邮箱：</samp></td>
             <td width="198"><input id="reges_inp" class="u_emails u_emails" type="text" name="zhemli"/></td>
             <td width="554" ><samp class="cvsfevs yazmdc_xn1" style="color: #aaa;">*填写你绑定的邮箱,必须与该账户绑定！</samp></td>
          </tr>
