...
<div id="xqweizi" style="border:0px solid red; height: 900px; margin-top: 10px;">
    ...
    <aside>
      ...
      <div class="userinfo" style="margin-top: 10px;"> 
        <p class="q-fans" style=" margin-left:-10px;"><samp style="color: red;font-weight: bold;">竞标人数：</samp><a href="javaScript:;">&nbsp;100</a>&nbsp;&nbsp;&nbsp;</p> 
      </div>
      <div class="userinfo1"> 
    ...
    <div class="blogitem">
      ...
      <article>
        ...
        <div class="textfoot">
          <div id="vsls11">
             <samp id="povbms" style="font-family:'微软雅黑';">${fn:substring(bder.btName,0,25)}...</samp>
          </div>
          <div id="vsls11">
             <samp id="povbms1" style="font-family:'微软雅黑'";>任务倒计时：<samp style=" color:red;">25时24分28秒</samp></samp>
          </div>
        </div>
      </article> 
      <article>
        ...
        <div class="textfootS1">
           <div id="lovsnf2" style="margin-left:52px;"><samp id="faburw" style="color: red;">发布任务</samp></div>
           <div id="lovsnf2" style="margin-left:31px;"><samp id="faburw">参与竞标</samp></div>
           <div id="lovsnf2" style="margin-left:30px;"><samp id="faburw">招标方选标</samp></div>
           <div id="lovsnf2" style="margin-left:30px;"><samp id="faburw">正式合作</samp></div>
           <div id="lovsnf2" style="margin-left:28px;"><samp id="faburw">收货付款</samp></div>
        </div>
        <div class="textfootS2">
           <div id="lovsnf1" style="text-align:center; border:1px solid red;"><img style="margin-top:8px;" src="images/xiao1.png"></div>
           <div id="lovsnf1" style="text-align:center;"><img style="margin-top:10px; margin-left:3px;" src="images/xiao2.png"></div>
           <div id="lovsnf1" style="text-align:center;"><img style="margin-top:10px;" src="images/xiao3.png"></div>
           <div id="lovsnf1" style="text-align:center;"><img style="margin-top:12px;" src="images/xiao4.png"></div>
           <div id="lovsnf1" style="text-align:center;"><img style="margin-top:12px;" src="images/xiao5.png"></div>
        </div>
      </article>
      <div id="vlwxolx">
...
<div id="haed_dibu_cc" style="margin-top:0px;">
