 ...
 <input type="hidden" id="bteidsdd" name="bteids" value="${bteids }"/>
     <div class="theme-popbod" style="border:0px solid #690;">
        ...
        <div id="tishcaoz2">
            ...
            <div id="tishitup2"><samp class="bsexs12">&nbsp;&nbsp;&nbsp;操作成功!</samp></div>
     ...
     <div class="theme-poptit" style="margin-top: 110px;"><a href="voiwtaskbt.action?bid=${bteids}" class="close"><div id="coslqed55"><samp class="xlxnss">返回</samp></div></a>
