...
<div id="void_nes1" style="border: 0px solid #ccc;   height: 780px;">
   <div id="mum_zhutiyi1">
      <ul id="mum_ul_s">
        ...
        <li id="mum_lncs1" class="mum_licss3"><a style="color: #690;" class="mum_asccss" href="Bidsuccess.action">我的任务订单</a></li>
   ...
   <div id="mum_zhutiyi2" style="border:1px solid #ccc; height: 840px;">
          <div id="rele_fabu1">
              ...
              <div id="rele_fbnc2"><h4 id="rele_fndn1">进行中的任务列表</h4></div>
          </div>
          <div id="rele_fabu4">
             <table border="0" width="780" cellpadding="0" cellspacing="0">
                <tr height="36">
                   <td align="center" width="110" style="font-size: 14px;  color: #666;">任务名称</td>
                   <td align="center" width="60" style="font-size: 14px;  color: #666;">任务价格</td>
                   <td align="center" width="60" style="font-size: 14px;  color: #666;">任务类型</td>
                   <td align="center" width="70" style="font-size: 14px;  color: #666;">开始时间</td>
                   <td align="center" width="70" style="font-size: 14px;  color: #666;">时间范围(小时)</td>
                   <td align="center" width="70" style="font-size: 14px;  color: #666;">操作</td>
                </tr>
             </table>
          </div>
          <div id="rele_fabu5">
          
          <c:forEach items="${binses.items}" var="ses">
             <div id="rele_uuc">
                  <a href="javaScript:;" style="text-decoration: none; color: #636;">
	              <div id="rele_oo1" style="border:0px solid red;width: 191px;"><div class="rele_cso" style="color: red;">${fn:substring(ses.btender.btName,0,15)}...</div></div>
	              </a>
	              <a href="javaScript:;" style="text-decoration: none; color: #636;">
	              <div id="rele_oo2" style="border:0px solid red;width: 106px;"><div class="rele_cso" style="color: red;">&nbsp;&nbsp;&nbsp;&nbsp;${ses.pjbrphone}.00USD($)</div></div></a>
	              <div id="rele_oo3" style="border:0px solid red;width: 106px;"><div class="rele_cso">&nbsp;&nbsp;${ses.btender.tvoice.tvtypeName}</div></div>
	              <div id="rele_oo4" style="border:0px solid red;width: 131px;"><div class="rele_cso" style="margin-top: 0px;">${ses.pfkTime}</div></div>
	              <div id="rele_oo6" style="border:0px solid red;width: 131px;"><div class="rele_cso" style="margin-top: 0px;">${ses.ptimelimit}(s)</div></div>
	              <div id="rele_oo5" style="border:0px solid red;width: 111px;">
	                     <a href="delepartpates!viewthebidding.action?prarid=${ses.pid}&yemas=${sesym}" target='_blank'><input style="margin-top: 15px;" type='button' onclick="" value='查看订单' class='sfgkanss' id='sfgkan2'/></a>
	              </div>
             </div>
           </c:forEach>  
          ...
          <div id="rele_fabu6" style="height: 50px;">
            ...
            <c:if test="${binses.totalCount==0}">
             ...
             <div style="margin-left: 330px;font-size: 16px;">暂无进行中的任务！</div>
            </c:if>
            </div>
          </div>
   </div>
...
<!----------底部样式------------->
<div>
<div id="haed_dibu_cc" style="margin-top:100px;">
...
window.onload = (function(){
	...
	//pageNav.go(1,2);
	 if(parseInt('${sesym}')==0){
	   pageNav.go(parseInt('${sesym}'),'${binses.totalPageCount}');
	}else{
	   pageNav.go(parseInt('${sesym}'),'${binses.totalPageCount}');
	}
 ...
 function showsub(id)
{
   window.location.href="Bidsuccess.action?sesym="+id;
}
  </script>
