...
<div id="void_nes1" style="border: 0px solid #ccc;   height: 780px;">
   <div id="mum_zhutiyi1">
      <ul id="mum_ul_s">
        ...
        <li id="mum_lncs1" class="mum_licss3"><a style="color: #690;" class="mum_asccss" href="odersovers.action">完成的订单</a></li>
   ...
   <div id="mum_zhutiyi2" style="border:1px solid #ccc; height: 840px;">
         ...
         <c:forEach items="${ywod.items }" var="yw">
             <div id="rele_uuc">
	              ...
	              <div id="rele_oo2" style="border:0px solid red;width: 120px;"><div class="rele_cso" style="color: red;">${yw.ptotalprice}.00USD($)</div></div></a>
	              ...
	              <div id="rele_oo5" style="border:0px solid red;width: 155px; text-align: center;">
	                     <a href="delepartpates!viewthebidding.action?prarid=${yw.pid}&yemas=${ywodym}" target="_blank"><input style="float: left; margin-top:15px; margin-left: 45px;border:1px solid #690;" type='button' onclick="" value='查看任务' class="sfgkanss33" id='sfgkan3'/></a>
	              </div>
             </div>
