...
<div id="void_nes1" style="border: 0px solid #ccc;   height: 780px;">
   <div id="mum_zhutiyi1">
      <ul id="mum_ul_s">
        ...
        <li id="mum_lncs1" class="mum_licss3"><a style="color: #690;" class="mum_asccss" href="voiceBiddings.action">竞标中的任务</a></li>
   ...
   <div id="mum_zhutiyi2" style="border:1px solid #ccc; height: 840px;">
          <div id="rele_fabu1">
              ...
              <div id="rele_fbnc2"><h4 id="rele_fndn1">参与竞标中的任务列表</h4></div>
          </div>
          <div id="rele_fabu4">
             <table border="0" width="780" cellpadding="0" cellspacing="0">
                <tr height="36">
                   ...
                   <td align="center" width="70" style="font-size: 14px;  color: #666;">任务预算价格</td>
                   <td align="center" width="70" style="font-size: 14px;  color: #666;">参与时间</td>
          ...
          <c:forEach items="${pidins.items }" var="din">
             <div id="rele_uuc">
                  <a href="javaScript:;" style="text-decoration: none; color: #636;">
	              <div id="rele_oo1" style="border:0px solid red;width: 239px;"><div class="rele_cso" style="color: red;">${fn:substring(din.btender.btName,0,15)}...</div></div>
	              </a>
	              <a href="javaScript:;" style="text-decoration: none; color: #636;">
	              <div id="rele_oo4" style="border:0px solid red;width: 143px;"><div class="rele_cso">${din.btender.tvoice.tvtypeName}</div></div>
	              <div id="rele_oo2" style="border:0px solid red;width: 120px;"><div class="rele_cso" style="color: red;">${din.pjbrphone}.00USD($)</div></div></a>
	              <div id="rele_oo3" style="border:0px solid red;width: 120px;"><div class="rele_cso" style="margin-top: 0px;">&nbsp;${din.pcyTime}</div></div>
	              <div id="rele_oo5" style="border:0px solid red;width: 155px; text-align: center;">
	                     <a href="delepartpates!viewthebidding.action?prarid=${din.pid}&yemas=${pdym}" target="_blank"><input style="float: left; margin-top:15px; margin-left: 5px;border:1px solid #690;" type='button' onclick="" value='查看任务' class="sfgkanss33" id='sfgkan3'/></a>
	                     <a href="delepartpates!deletpingds.action?pids=${din.pid }"><input style=" float: left;margin-top:15px; margin-left: 5px;border:1px solid #690;" type='button' onclick="" value='取消竞标' class="sfgkanss33" id='sfgkan3'/></a>
	              </div>
             </div>
          </c:forEach>   
          ...
          <div id="rele_fabu6" style="height: 50px;">
            ...
            <div id="pageNav" style="border:0px solid red; width:780px; margin-left: 80px;"></div>
             ...
             <div style="margin-left: 330px;font-size: 16px;">暂无竞标中的任务！</div>
             </c:if>
            </div>
          </div>
   </div>
...
window.onload = (function(){
	...
	//pageNav.go(1,22);
	 if(parseInt('${pdym}')==0){
	   pageNav.go(parseInt('${pdym}'),'${pidins.totalPageCount}');
	}else{
	   pageNav.go(parseInt('${pdym}'),'${pidins.totalPageCount}');
	}
...
function showsub(id)
{
   window.location.href="voiceBiddings.action?pdym="+id;
}
