...
<html>
  <head>
    ...
    <title>Mailbox verification</title>
...
<div id="reges_gndh" style="width: 1000px; height: 380px; border:0px dashed #ccc; border-width: 0px 0px 1px 0px;">
   <div id="reges_dh1" style="border:0px dashed #ccc; border-width: 0px 0px 1px 0px;"><h3 id="reges_h3">Email Verification</h3></div>
   <div id="reges_dh8" style="width: 1000px; height: 300px; border:0px solid red;">
       <form id="formczshn" method="post" action="ehloginUserehs!VerificationEh.action">
         <table border="0" width="990" cellpadding="0" cellspacing="0" style="margin-top: 50px;">
          <tr height="35">
             <td width="200" align="right"><samp style="font-size: 14px; color:#660;">*User Name:</samp></td>
             <td width="150"><samp style="font-size: 13px;">${yzhuser}</samp></td>
             <td width="550"></td>
          </tr>

          <tr height="35">
             <td width="200" align="right"><samp style="font-size: 14px; color:#660;">*Received verification code:</samp></td>
             <td width="150"><input id="reges_inp" class="regsscs_yam" type="text" name="jsdcod" maxlength="6"/></td>
             <td width="550"><samp class="yazmdc_xn1 yazmdcsv_oo">Type the verification code received in your email!</samp></td>
          </tr>
          <tr height="35">
           ...
           <tr height="35">
             <td width="200" align="right"></td>
             <td width="150"><input class="uscn_tijao" type="submit" value="Submit"/></td>
             <td width="550"></td>
          </tr>
       </table>
   </form>
