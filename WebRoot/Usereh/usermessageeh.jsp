...
<html>
  <head>
    ...
    <title>You are chatting with the client service!</title>
...
<div id="seiverliatot">
  <div id="zaixyonghu1">
     <div id="usercount1" style="border:0px solid red;">
        ...
        <s:if test="#session.users==null">
        <div id="userzhi2"><samp style="font-size:12px; line-height:30px;">Account:${username }</samp></div>
        <%-- <div id="userzhi2"><samp style="font-size:12px; line-height:30px;">Character:${username }</samp></div> --%>
        <div id="userzhi2"><a href="indexpage!logincon" style="color: red; text-decoration: none;" target="_blank"><samp style="font-size:14px; line-height:30px;">Login</samp></a></div>
        </s:if>
        <s:if test="#session.users!=null">
        <div id="userzhi2"><samp style="font-size:12px; line-height:30px;">Account:<samp id="usersNamesids" style="font-size:14px; color:red;">${users.iuserName}</samp></samp></div>
  ...
  <div id="zaixyonghu2">
     <div id="sysdinds1"><samp style="font-size:20px; line-height:40px; font-weight:bold; color:#333;">You are chatting with the client service!</samp></div>
     ...
     <div id="sysdinds2">
        ...
        <div id="newslists">
         ...
         <div id="newsjilu" style="float:right;">
            ...
            <div id="news2" style="float:right; margin-right:2px;"><div id="mansess"><samp id="xizyssl">Hi, What can i do for you?</samp></div></div>
         </div>
     ...
     <div id="sysdinds3">
        ...
        <div id="fasongx" style="text-align:center;">
           <a href="javaScript:funcitonsto();"><div style="margin-right:-4px;" id="fssubmt"><samp style="line-height:26px; font-size:16px; font-weight:bold; color:#7F0000;">Send</samp></div></a>
           <a href="#"><div style="float:left;" id="fssubmt"><samp style="line-height:26px; font-size:16px; font-weight:bold; color:#7F0000;">Back to Home</samp></div></a>
           <a href="javaScript:;"><div style="float:left; width:150px;" id="fssubmt"><samp style="line-height:26px; font-size:16px; font-weight:bold; color:#7F0000;">Delete records</samp></div></div></a>
        </div>
     </div>
  </div>
</div>
