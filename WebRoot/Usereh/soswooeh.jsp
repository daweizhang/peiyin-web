  ...
  <div id="lsncs_olc1">
    <table width="495" height="38" border="0" cellpadding="0" cellspacing="0"> 
      <tr>
        ...
        <td width="446" align="left"><span id="dlnzhti">Note:</span></td>
      </tr>
    </table>
  </div>
  <div id="lsncs_olc2">
      ...
      <div id="tishtuslxx">
         <span class="svege">${errorxx}</span>
      </div>
  </div>
  <div id="lsncs_olc3">
     <a class="sesscs" href="ehloginUserehs!findUserTypeEh.action"><input id="cnwlbann1" type="button" value="OK"/></a>
     <s:if test="nclsn==2">
     <a class="sesscs" href="ehindexpage!loginconEh.action"><input id="cnwlbann1" type="button" value="Login"/></a>
     </s:if>
  </div>
</div>
  </body>
