...
<div id="reges_gndh" style="width: 1000px; height: 380px; border:0px dashed #ccc; border-width: 0px 0px 1px 0px;">
   <div id="reges_dh1" style="border:0px dashed #ccc; border-width: 0px 0px 1px 0px;"><h3 id="reges_h3">Enter a new password</h3></div>
   <div id="reges_dh8" style="width: 1000px; height: 300px; border:0px solid red;">
       <form action="ehloginUserehs!updateusEh.action" method="post" id="formxinmm">
       <table border="0" width="990" cellpadding="0" cellspacing="0" style="margin-top: 50px;">
          ...
          <tr height="35">
             <td width="200" align="right"><samp style="font-size: 16px; color:#660;">*New password：</samp></td>
          ...
          <tr height="35">
             <td width="200" align="right"><samp style="font-size: 16px; color:#660;">Confirm new password：</samp></td>
