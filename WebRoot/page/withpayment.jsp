    ...
    <div class="content_resize">
      <div class="mainbar"><div class="submb">
        <div class="article">
          ...
          <br>
              <samp style="font-size:16px; color:#F60; font">任务方支付费用=任务方最终选中的配音员所提交的竞标价</samp><br>
              <samp style="font-size:16px; color:#F60; font">配音员所获报酬=任务方支付费用-15%平台服务费</samp>
          </div>
        </div>
        <div class="article flns">
          <samp id="slinwsjianyi1">支付方式</samp>
           <div id="gywmxx" style="border:0px solid red;">
               ...
               <samp style="font-size:16px;">任务方支付方式：<br><samp style="color:red;">第一种：通过《Paypal》平台支付!<br>支付账户:account@chinesevoiceoverfreelancers.com</samp></samp><br>
               <samp style="font-size:16px;"><samp style="color:red;">第二种：通过《支付宝》平台支付!<br>支付账户:account@chinesevoiceoverfreelancers.com</samp></samp><br>
               
               
               <samp style="font-size:16px;">配音员收款方式：<samp style="color:red;">通过《支付宝》平台收款。交付产品时需填写您的真实姓名和支付宝账户</samp></samp>
           </div>
           <br>
