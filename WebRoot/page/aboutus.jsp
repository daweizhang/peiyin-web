    ...
    <div class="content_resize">
      <div class="mainbar"><div class="submb">
        <div class="article">
          ...
          <div id="gywmxx" style="color:#666;"><img style="border:0px; float:left;" src="images/lzs55.png" width="150" height="150"/>&nbsp;&nbsp;&nbsp;&nbsp;
          
          Chinesevoiceoverfreelancers （CVF） 龙之声配音致力于打造全球最大的华语配音竞聘平台。平台旨在帮助配音员与配音需求方实现双方直接交易，去除中间商环节，将原本由中间商层层加码产生的差价让渡给买卖双方，实现“需求方少付款，配音员多赚钱”的双赢局面。 平台采用竞标模式为需求方发布的每一个项目选择最佳配音员。同时杜绝低价海选，所有项目起配价为300元，且对项目竞标人数予以限制，最大程度保障配音员的收益。      
        ...
        <div class="article flns">
          <samp id="slinwsjianyi1">联系我们</samp>
           <div id="gywmxx">
              <samp id="gsdz45">地址：</samp><samp>重庆市沙坪坝区金沙时代11-31-7 </samp><br /><br />
              <samp id="gsdz45">业务电话：</samp><samp>023-6384 2220</samp><br /><br />
              <samp id="gsdz45">急速配音：</samp><samp>(86)173 167 80 906</samp><br /><br />
              <samp id="gsdz45">电子邮箱：</samp><samp>info@chinesevoiceoverfreelancers.com</samp><br /><br />
              <samp id="gsdz45">客服QQ：</samp><samp>83977692</samp><br /><br />
           </div>
        </div>
