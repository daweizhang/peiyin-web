...
<div id="void_nes1" style="border: 0px solid #ccc;  height: 850px; margin-top: 0px;">
   ...
   <div class="mainContent" style="margin-left: -1px;">
    <aside>
      ...
      <section class="topspaceinfo">
        <samp id="leknmjj">工作年限：</samp>
        <samp id="lekgfont">${rs.ipynx }</samp>
      </section>
      <section class="topspaceinfo">
      ...
      <div class="userinfo" style="line-height: 25px;"> 
        <p class="q-fans"> &nbsp;服务度：<a href="javaScript:;">${voicescoes }</a>&nbsp;(累计交易评分平均值)</p>  
        <p class="q-fans"> &nbsp;交易量：<a href="javaScript:;">${rs.iscoced }</a>&nbsp;(交易次数)</p>  
...
<div>
<!-- d1 -->
		<div id="haed_dibu_cctts" style="margin-top:150px;">
