     ...
     <div id="zuopinxiug" class="theme-popbod dform" style="height: 300px;"> 
          ...
          <div id="zuopingzti">
                <div id="donttaijiz" style="margin-top: 10px;">           
                 ...
                 <table style="margin-top: 5px;" border="0" width="555" cellpadding="0" cellspacing="0">
                    <tr height="50">
                       <td width="112" align="right"><span style="color: red;"></span><span class="fbrw_btii" style="font-size: 15px;">我的报价：</span></td>
                       <td width="320" align="left" style="font-size: 14px;">
                            <samp id="sampcsslsa">${pfu.pjbrphone}.00(RMB)</samp>
                 ...
                 <table border="0" width="555" cellpadding="0" cellspacing="0">
                    <tr height="50">
                       ...
                       <td width="320" align="left" style="font-size: 14px;">
                           <samp id="sampcsslsa">${pfu.pjbrphone}.00(RMB)&nbsp;&nbsp;-酬金${pfu.pjbrphone}×15%(平台佣金)=${pfu.pthefinalfee}(RMB)<samp style="font-size: 14px; color: #666;">(<a href="indexpage!jumpfyfk.action">点我了解详情</a>)</samp></samp>
                       </td>
                    </tr>
                 </table>
               ...
               <table border="0" width="555" cellpadding="0" cellspacing="0">
                    <tr height="50">
                       ...
                       <td width="320" align="left" style="font-size: 15px;">
                           <a href="download.action?filename=/voicefile/${pfu.btender.bvoicefileName}"><input style="width: 100px; height: 30px; background-color: #690; border:0px; color: #fff;" type="button" value="下载正式稿文"/></a>
                           <c:if test="${pfu.btender.bypfile==''}">
                           <a href="download.action?filename=/yinyue/${pfu.btender.bypfile}"><input style="width: 180px; height: 30px; background-color: #690; border:0px; color: #fff;" type="button" value="下载背景音乐或者视频文件"/></a>
                           </c:if>
                       </td>
                    </tr>
                 </table>
