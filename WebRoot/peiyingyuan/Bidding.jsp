   ...
   <div id="mum_zhutiyi2" style="border:1px solid #ccc; height: 840px;">
          ...
          <div id="rele_fabu4">
             <table border="0" width="780" cellpadding="0" cellspacing="0">
                <tr height="36">
                   ...
                   <td align="center" width="70" style="font-size: 14px;  color: #666;">竞标价格</td>
          ...
          <c:forEach items="${pidins.items }" var="din">
             <div id="rele_uuc">
	              ...
	              <div id="rele_oo1" style="border:0px solid red;width: 239px;"><div class="rele_cso" style="color: red;">${fn:substring(din.btender.bftranslate.bfNames,0,15)}...</div></div>
	              </a>
	              <a href="javaScript:;" style="text-decoration: none; color: #636;">
	              <div id="rele_oo4" style="border:0px solid red;width: 143px;"><div class="rele_cso">${din.btender.tvoice.tvtypeName}</div></div>
	              <div id="rele_oo2" style="border:0px solid red;width: 120px;"><div class="rele_cso" style="color: red;">${din.pjbrphone}.00RMB(￥)</div></div></a>
