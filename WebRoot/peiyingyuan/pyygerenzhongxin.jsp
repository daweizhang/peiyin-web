			...
			<div id="head_logo_u2">
				<div id="head_dh1">
					<ul id="head_ul_list" style="margin-right: 0px;">
						...
						<li class="li_lasp" style="color: #690;">欢迎来到本站1</li>
...
<div id="void_nes1" style="border: 0px solid #ccc;   height: 850px;">
   ...
   <div id="sk_touxherd2">
     <table width="734" height="135" border="0" cellpadding="0" cellspacing="0">
       ...
       <tr>
         ...
         <input type="hidden" value="${ius.iphone }" id="gerenzhongx"/>
   ...
   <div id="sk_touxherd3">&nbsp;&nbsp;<samp style="font-size:15px; color:#999;">♪工作年限：</samp><samp style="font-size:16px; color:#757575; font-weight:bold;">${ius.ipynx}</samp></div>
   <div id="sk_touxherd3">
  ...
  <div id="sk_touxherd3" style="border:0px solid red; height:30px; text-align:center;"><span id="idnlsns" style="color: red; font-weight: bold;"></span></div>
   <div id="sk_touxherd4">
     <table width="738" border="0">
       <tr>
         <td width="184" height="34">&nbsp;</td>
