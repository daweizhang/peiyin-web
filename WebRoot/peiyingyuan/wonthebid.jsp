   ...
   <div id="mum_zhutiyi2" style="border:1px solid #ccc; height: 840px;">
          ...
          <c:forEach items="${binses.items}" var="ses">
             <div id="rele_uuc">
	              ...
	              <div id="rele_oo1" style="border:0px solid red;width: 191px;"><div class="rele_cso" style="color: red;">${fn:substring(ses.btender.bftranslate.bfNames,0,15)}...</div></div>
	              </a>
	              <a href="javaScript:;" style="text-decoration: none; color: #636;">
	              <div id="rele_oo2" style="border:0px solid red;width: 106px;"><div class="rele_cso" style="color: red;">&nbsp;&nbsp;&nbsp;&nbsp;${ses.pjbrphone}.00RMB(￥)</div></div></a>
