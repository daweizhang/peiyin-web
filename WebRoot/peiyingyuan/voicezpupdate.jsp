...
<div class="theme-popover" style="z-index: 2; height: 600px;">
     <div id="zuopinxiug" class="theme-popbod dform" > 
          ...
          <div id="zuopingzti">
                <div id="donttaijiz">
             <form action="voicemiets!updateworkszp.action" name="" method="post" id="zpupdate"> 
                <!-- <form action="worksgllist.action" name="" method="post" id="zpupdate"> -->
                 ...
                 <table border="0" width="555" cellpadding="0" cellspacing="0">
                    <tr height="50">
                       ...
                       <td width="250" style="font-size: 14px;"><input type="text" id="zuopinName" style="float: left;" name="wkup.worksName" class="fbrw_libit6" maxlength="25" value="${works.worksName}"></td>
                ...
                <table border="0" width="555" cellpadding="0" cellspacing="0">
                 ...
                 <table border="0" width="555" cellpadding="0" cellspacing="0">
                    <tr height="50">
                       <td width="112" align="right"><span style="color: red;">♫</span><span class="fbrw_btii">本人口音：</span></td>
                       <td width="120" style="font-size: 14px;">
     ...
     <table border="0" width="555" cellpadding="0" cellspacing="0">
                    <tr height="50">
                       <td width="130" align="right"><span style="color: red;"></span><span class="fbrw_btii"></span></td>
                       <td width="450" style="font-size: 14px;"><span id="updatetext" style="color: red; font-weight: bold;"></span></td>
                       <td width="18" align="left"><span style="font-size:14px; color: #666;"></span></td>
                    </tr>
                 </table>
     <div class="theme-poptit" style="border:0px solid #690; margin-top: 0px;">
         <div><input class="close1" type="submit" value="提交更新"/></div>
         <a href="worksgllist.action?djydd=${djy}" class="fgclose">
            <div class="close1" style="margin-left: 35px;">返回</div>
         </a>
     </div>
</div>
</form>
