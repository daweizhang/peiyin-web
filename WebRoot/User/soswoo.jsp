...
<div id="thistis_icnicns">
  ...
  <div id="lsncs_olc3">
     <a class="sesscs" href="loginUsers!findUserType.action"><input id="cnwlbann1" type="button" value="确定"/></a>
     <s:if test="nclsn==2">
     <a class="sesscs" href="User/login.jsp"><input id="cnwlbann1" type="button" value="马上登陆"/></a>
     </s:if>
  </div>
</div>
  </body>
