...
<html>
  <head>
    ...
    <title>Voice staff home page</title>
					...
					<ul id="head_ul_list" style="margin-right: 0px;">
						...
						<s:if test="#session.users==null">
							<li class="li_lasp"><a class="li_laspc_a" target="_blank"
								href="ehindexpage!loginconEh">login</a>/<a class="li_laspc_a"
								href="ehloginUserehs!findUserTypeEh" target="_blank">registered</a></li>
						</s:if>
						<s:if test="#session.users!=null">
							<li class="li_lasp"><a style="margin-right: 10px;"
								class="li_laspc_a" href="exituser!userexitxt">drop out</a>
						</s:if>
					</ul>
				</div>
				<div id="head_dh2">
					<ul id="head_ul_list1" style="margin-right: 10px;">
						<li class="li_lasp1"><a target="_blank" class="li_laspc_a1"
							href="ehindexpage!jumpjylcEh">Transaction process</a></li>
						<li class="li_lasp1"><a target="_blank" class="li_laspc_a1"
							href="ehindexpage!jumpfyfkEh">Fees and payments</a></li>
						<li class="li_lasp1"><a target="_blank" class="li_laspc_a1"
							href="ehindexpage!jumpcjwtEh">common problem</a></li>
						<li class="li_lasp1"><a target="_blank" class="li_laspc_a1"
							href="ehindexpage!jumptsjyEh">Complaints and Suggestions</a></li>
						<li class="li_lasp1"><a target="_blank" class="li_laspc_a1"
							href="ehindexpage!jumpgywmEh">about us</a></li>
					</ul>
				</div>
			</div>
		</div>
...
<div id="void_nes1" style="border: 0px solid #ccc;   height: 850px;">
   <div id="mum_zhutiyi1">
      <ul id="mum_ul_s">
        ...
        <li id="mum_lncs0" class="mum_licss3"><a style="color: #690;" class="mum_asccss" href="loginUsers!rupinuzy.action">homepage</a></li>
        <li id="mum_lncs0" class="mum_licss"><a class="mum_asccss" href="personalcenter.action">Personal Center</a></li>
        <li id="mum_lncs1" class="mum_licss"><a class="mum_asccss" href="uplaodvoicezp.action">Upload work</a></li>
        <li id="mum_lncs1" class="mum_licss"><a class="mum_asccss" href="worksgllist.action">Work management</a></li>
        <li id="mum_lncs1" class="mum_licss"><a class="mum_asccss" href="voiceBiddings.action">Bidding task</a></li>
   ...
   <div id="mum_zhutiyi2">
         <div id="mum_grzls1">
            ...
            <div id="mun_listcc3">
                ...
                <div id="mun_lsnmcn5">
                   ...
                   <tr height="30">
                      <td width="40" style="font-size: 13px; color: #666;">参与的任务:</td>
         ...
         <div id="mun_fnmcs8">
            <div id="ywcdpeyr_li1"><div class="h4_ywcll">进行中的任务</div><div class="h4_ywcll1"><a href="#" class="her_lnd">查看更多...</a></div></div>
            <div id="ywcdpeyr_li2">
