...
<div id="void_nes1" style="border: 0px solid #ccc;   height: 850px;">
   ...
   <div id="mum_zhutiyi2" style="border:1px solid #ccc;">
          ...
          <form action="voicemiets!uploadworks.action" method="post" enctype="multipart/form-data">
              <div id="fbrw_addl" >
              ...
              <div id="fbrw_addl">
                 <table border="0" width="750" cellpadding="0" cellspacing="0">
                    <tr height="50">
                       ...
                       <td width="370" style="font-size: 14px;"><input type="text" name="works.worksName" class="fbrw_libit6"></td>
              ...
              <div id="fbrw_addl">
                 <table border="0" width="750" cellpadding="0" cellspacing="0">
                    <tr height="50">
                       ...
                       <td width="370" style="font-size: 14px;">
                          <select style="width: 170px;" class="fbrw_libit3" name="vic">
              ...
              <div id="fbrw_addl">
                 <table border="0" width="750" cellpadding="0" cellspacing="0">
                    <tr height="50">
                       ...
                       <td width="370" style="font-size: 14px;">
                          <select style="width: 170px;" class="fbrw_libit3" name="lgs">
							  <option value="0">请选择</option>
              ...
              <div id="fbrw_addl">
                 <table border="0" width="750" cellpadding="0" cellspacing="0">
                    <tr height="50">
                       <td width="150" align="right"><span style="color: red;">♫</span><span class="fbrw_btii">配音阶段：</span></td>
                       <td width="370" style="font-size: 14px;">
                          <select style="width: 170px;" class="fbrw_libit3" name="sro">
							  <option value="0">请选择</option>
              ...
              <div id="fbrw_addl">
                 <table border="0" width="750" cellpadding="0" cellspacing="0">
                    <tr height="50">
                       ...
                       <td width="370" style="font-size: 14px;">
                          <select style="width: 170px;" class="fbrw_libit3" name="sysli">
							  <option value="0">请选择</option>
