...
<div class="theme-popover" style="z-index: 2;position:relative; width: 900px; height:1150px; margin:-180px 0 0 -452px; ">
     <div id="zuopinxiug" class="theme-popbod dform" style="width: 800px;"> 
          ...
          <div id="zuopingzti" style="border:0px solid red; height:1050px; width: 900px; margin-top: 15px;">
                <div id="donttaijiz" style="width: 900px;border:0px solid red;">
             <!--<form id="tisrwbjfrom" action="betencaozuo!updateBtender.action" method="post" enctype="multipart/form-data"> -->
               <form id="tisrwbjfrom" action="btenlist.action" method="post" enctype="multipart/form-data">
                 ...
                 <table border="0" width="900" cellpadding="0" cellspacing="0">
                    <tr height="50">
                       ...
                       <td width="280" style="font-size: 14px;"><input id="rewnumingxs" maxlength="45" type="text" style="float: left; width: 397px;" name="bndrs.btName" class="fbrw_libit6" value="${tenderrw.bftranslate.bfNames }"></td>
                       <td width="365" align="left"><span style="font-size:14px; color: #666;">任务名称大于5个字并且小于45个字!</span></td>
                    </tr>
                 </table>
                 <table border="0" width="900" cellpadding="0" cellspacing="0">
                    <tr height="50">
                       <!--  <td width="123" align="right"><span style="color: red;">*</span><span class="fbrw_btii">正式稿文字数：</span></td> -->
                       <!-- david update delete * for this td -->
                       <td width="123" align="right"><span class="fbrw_btii">正式稿文字数：</span></td>
                       <td width="157" style="font-size: 14px;" align="left">
                           <input id="zsgwzshus" type="text" style="float: left; width: 115px;" name="bndrs.basofTime" class="fbrw_libit6" value="${tenderrw.basofTime }">(字)
                       </td>
                       <td width="93" align="right"><span style="color: red;">*</span><span class="fbrw_btii">预算价位：</span></td>
                        <td width="527" style="font-size: 14px;" align="left">
                        <input type="text" id="bjysjw" style="float: left; width: 148px;" name="bndrs.bprice" class="fbrw_libit6" value="${tenderrw.bprice }">(RMB)
						  </td>
                    </tr>
                 </table>
                <table border="0" width="900" cellpadding="0" cellspacing="0">
                 ...
                 <table border="0" width="900" cellpadding="0" cellspacing="0">
                    <tr height="200">
                       ...
                       <textarea id="rwnshiygwsbj" class="fbrw_libit4" name="bndrs.bpygaowen" style="float: left; width: 678px; height: 200px;" cols="" rows="">${tenderrw.bftranslate.bfsygw}</textarea>
                       </td>
                       <td width="100"></td>
                    </tr>
                 </table>
                 ...
                 <table border="0" width="900" cellpadding="0" cellspacing="0">
                    <tr height="50">
                       ...
                       <td width="78" style="font-size: 14px;">
                           <span style="font-size:14px; color: #666;"><a href="javascript:bofang('${fn:substring(tenderrw.bftranslate.bfNames,0,8)}...','${tenderrw.bypfile}');"><img src="images/isc.ico" width="28" height="28"></img></a></span>
                       </td>
                 ...
                 <table border="0" width="900" cellpadding="0" cellspacing="0">
                    <tr height="100">
                       ...
                       <td width="700" align="left"><span style="font-size:14px; color: #666;"><%-- ${tenderrw.bvoicefileName} --%><br><a style="text-decoration: none;" href="download.action?filename=/voicefile/${tenderrw.bvoicefileName }">下载查看</a></span></td>
                    </tr>
                 </table>
                 <table border="0" width="900" cellpadding="0" cellspacing="0">
                    <tr height="50">
                 ...
                 <table border="0" width="900" cellpadding="0" cellspacing="0">
                    <tr height="100">
                       ...
                       <!-- david delete * for this div -->
                       <td width="122" align="right"><span class="fbrw_btii">任务细节描述：</span></td>
                       <td width="678" style="font-size: 14px;" colspan="2"> 
                       <textarea class="fbrw_libit4" name="bndrs.bxxmiaoshu" style="float: left; width: 678px; height: 100px;" cols="" rows="">${tenderrw.bftranslate.bftiser}</textarea>
                       </td>
                       <td width="100"></td>
                    </tr>
                 </table>
...
<div id="thistis_icnicns" style="display: none;z-index: 10;">
  ...
  <div id="lsncs_olc2">
      ...
      <div id="tishtuslxx">
         <span class="svege">无法更新有配音员参与竞标的任务!</span>
      </div>
  </div>
  <div id="lsncs_olc3">
         ...
         $(data.prlist.items).each(function(){
              ...
              htmlpt+="<table border='0' width='900' cellpadding='0' cellspacing='0'>"
	                    +"<tr height='30' id='fslkvsc_voice'>"
	                       ...
	                       +"<td width='170' align='center'><span style='font-size: 13px; color: #999;'>"+this.pjbrphone+".00(RMB)</span></td>"
	                       ...
	                       +"<td width='225' align='center'><a href='insvoiw.action?uid="+this.puserId.iid+"' target='_blank'><input id='anniuys' type='button' value='查看资料'/></a>&nbsp;<a href='Confirmation.action?pid="+this.pid+"'></a>&nbsp;<a href='Confirmation.action?pid="+this.pid+"'><input id='anniuys' type='button' value='马上合作'/></a></td>"
	                    +"</tr>"           
	                 +"</table>";
