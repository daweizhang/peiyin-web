...
<div class="theme-popover" style="height: 530px; margin-top: -230px; display: block; z-index: 998;">
 <input type="hidden" id="bteidsdd" name="bteids" value="${bteids }"/>
     <div class="theme-popbod" style="border:0px solid #690;">
        ...
        <form id="formtijiasz" action="paymento.action" method="post" id="addprtpageid">
       ...
       <div id="tishcaoz2" style="border:0px solid red; height: 30px; margin-top: 10px;">
           <table width="555" height="30" border="0">
            <tr>
              ...
              <td width="394" align="left" valign="middle">
                 <div class="uploader green" style="margin-top:5px; padding:0px;">
                    <input type="text" class="fbrw_libit6" value="${pats.btender.bftranslate.bfNames }" readonly="readonly"/>
                </div>
              </td>
            </tr>
          </table>
       ...
       <div id="tishcaoz2" style="border:0px solid red; height: 60px; margin-top: -2px;">
           <table width="555" height="40" border="0">
            <tr height="20">
              ...
              <td width="394" align="left" valign="middle">
                 <div class="uploader green" style="margin-top:5px; padding:0px;">
                    <samp id="wnllfont">${pats.pjbrphone }RMB(￥)</samp>
                    <input type="hidden" name="te.ptotalprice" value="${pats.pjbrphone}">
                </div>
              </td>
            </tr>
            <tr height="15">
       ...
       <div id="tishcaoz2" style="border:0px solid red; height: 104px;">
            ...
            <tr>
              ...
              <td width="394" align="left" valign="middle">
                 <div class="uploader green" style="margin-top:0px; padding:0px;">
                    <samp style="color:#F60; font-size: 14px;">请确认以上信息,如有问题请联系客服人员！如确认无误,填写</samp><br/>
                    <samp style="color:#F60; font-size: 14px;">您的支付宝款账号!合作期间,您如果有什么疑问,请通过</samp><br/>
        ...
        <div id="tishcaoz2" style="border:0px solid red; height: 60px; margin-top: 5px;">
           <table width="555" height="40" border="0">
            <tr height="20">
              <td width="145" align="right" valign="middle" ><span id="xxss55"><samp style="color: red;">*</samp>支付宝付款账户：</span></td>
              <td width="394" align="left" valign="middle">
                 <div class="uploader green" style="margin-top:0px; padding:0px;">
                    <input id="zhifbhes" type="text" class="fbrw_libit6" name="te.paycount" maxlength="25"/>
                </div>
              </td>
            </tr>
            <tr height="15">
    ...
    <%--  <input type="hidden" class="fbrw_libit6" name="uupid" value="${pats.pid}"/> --%>
