...
<div id="void_nes1" style="border: 0px solid #ccc;   height: 850px;">
   <div id="mum_zhutiyi1">
      <ul id="mum_ul_s">
        ...
        <li id="mum_lncs1" class="mum_licss3"><a style="color: #690;" class="mum_asccss" href="taskparty/rwfupadatepas.jsp">修改密码</a></li>
   ...
   <form id="rwfupdapss" action="loginUsers!updatepasswordmm.action" method="post">
   <!-- 中间的内容DIV -->
