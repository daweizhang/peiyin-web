...
<div id="void_nes1" style="border: 0px solid #ccc;   height: 850px;">
   <div id="mum_zhutiyi1">
      <ul id="mum_ul_s">
        ...
        <li id="mum_lncs1" class="mum_licss"><a class="mum_asccss" href="personalcenter.action">个人中心</a>
   ...
   <div id="mum_zhutiyi2">
            ...
            <div id="mun_listcc3">
                ...
                <div id="mun_lsnmcn5">
                   ...
                   <tr height="30">
                      ...
                      <td width="60" style="font-size: 13px; color:#F90;"><samp style="font-size:16px;color:#F60; font-weight:bold;">${po.totalCount}</samp>&nbsp;(个)</td>
                   </tr>
                   </table>
         ...
         <div id="mun_fnmcs8">
            <div id="ywcdpeyr_li1"><div class="h4_ywcll">进行中的任务订单</div><div class="h4_ywcll1"><a href="conJumptaskorder.action" class="her_lnd">查看更多...</a></div></div>
            <div id="ywcdpeyr_li2" style="border:1px solid #ccc;height: 363px;">
              ...
              <c:forEach items="${po.items }" var="isd">
                <div id="yyq1s3">
                   <div id="xx_cc_ii1">
                      <div style="margin-top: 15px; margin-left: 5px;"><a class="iid_kcnc1" href="#">${fn:substring(isd.btender.bftranslate.bfNames,0,15)}...</a></div>
                   </div>
                   <div id="xx_cc_ii2" style="text-align: center;"><div style="margin-top: 15px; font-size: 15px;">${isd.btender.tvoice.tvtypeName }</div></div>
                   <div id="xx_cc_ii3" style="text-align: center;"><div style="margin-top: 15px; font-size: 15px;">${isd.pfqTime }</div></div>
                   <div id="xx_cc_ii4" style="text-align: center;"><a href="paymenthasbeenrw.action?menpid=${isd.pid}&nspid=1" style="text-decoration: none;"><div id="ffcc_kld"><div style="margin-top: 5px; font-size: 14px;">立即查看</div></div></a></div>
                </div>
               </c:forEach>
            </c:if>
            <c:if test="${po.totalCount == 0}">
              <div style="width: 700px;height: 323px;border:0px solid red; color: #666; font-size: 14px; text-align: center;"><div style="margin-top: 100px;"><span>暂无进行中的任务订单</span>&nbsp;&nbsp;<a href="voiceyindex.action" style="color: red; text-decoration: underline;">立即邀请配音员配音</a></div></div>
            </c:if>
            ...
            <div id="ywcdpeyr_li3" style="border:0px solid red;">
                ...
                <div id="yhncjwt_kc">
                   <table border="0" width="780" cellpadding="0" cellspacing="0" style="margin-top: 12px;">
                      ...
                      <tr height="35">
                         <td><a class="sfcjwt_ic" href="#">.邮箱无法接收验证码?</a></td>
                         
                      </tr>
                      <tr height="35">
                         <td><a class="sfcjwt_ic" href="#">.如何进行付款？</a></td>
                       
                      </tr>
                      <tr height="35">
                         <td><a class="sfcjwt_ic" href="#">.如何进行提交bug？</a></td>
