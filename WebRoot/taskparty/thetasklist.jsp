       ...
       <input type="hidden" id="hiddjy" value="${rwdjy}">
          ...
          <!--  <div id="sfgk1">
	       ...
	       <c:forEach items="${bten.items}" var="bt">  
             <div id="rele_uuc">
	              <div id="rele_oo1" style="width: 191px;border:0px solid red;"><a href="javascript:('${bt.bid}');" style="text-decoration: none;"><div id="rele_cso1ss" class="rele_cso" style="font-size: 13px;">${fn:substring(bt.bnamebf,0,20)}...</div></a></div>
	              <div id="rele_oo2" style="width: 97px;border:0px solid red;"><div class="rele_cso" style="font-size: 13px;">&nbsp;&nbsp;${bt.bvoicetype }</div></div>
	              <div id="rele_oo3" style="width: 98px;border:0px solid red;">
	                   <div class="rele_cso" style="font-size: 14px; color: red; font-weight: bold;">${bt.count}
	                        <a color: red; href="javascript:void(0)" onclick="showPartnerPage('${bt.bid}')"> 查看</a>
	                   </div>
	              </div>
...
<div id="thistis_icnicns" style="display: none;">
  ...
  <div id="lsncs_olc2">
      ...
      <div id="tishtuslxx">
         ...
         <span id="showrw2" class="svege" style="display: none;">无法删除有配音员参与竞标的任务!</span>
              ...
              <form action="voicemiets!updateworkszp.action" name="" method="post">
                 ...
                 <table border="0" width="900" cellpadding="0" cellspacing="0" style="margin-top: 10px;">
                    <tr height="45">
                       ...
                       <td width="220"><span style="font-size: 13px; color: #690;">共<span class="spcount1">
                       </span>条记录&nbsp;每页显示<span class="spcount2"></span>条</span></td>
                    </tr>
                 </table>
              </div> 
          </div>
...
function showPartnerPage(btId){
	
	//alert("david:" + btId);
	var htmlpt="";
	$.getJSON("/peiyin//betencaozuo!finpartpate.action",{"ptid": btId},function(data){
		
        //alert("david:"+JSON.stringify(data));
        if(data.prlist.totalCount!=0){
            ...
            //$("#pageNav").hide();
            htmlpt+="<div id='sefegsd'>该任务当前无配音员参与竞标!<a href='#' style='color:red;'>马上邀请>></a><div>";
        }
