   ...
   <div id="mum_zhutiyi2" style="border:1px solid #ccc; height: 840px;">
          ...
          <c:forEach items="${podsu.items }" var="ptu">
             <div id="rele_uuc">
	              ...
	              <div id="rele_oo1" style="border:0px solid red;width: 191px;"><div class="rele_cso" style="color: red;">${fn:substring(ptu.btender.bftranslate.bfNames,0,20)}...</div></div>
	              </a>
	              <a href="javaScript:;" style="text-decoration: none; color: #636;">
	              <div id="rele_oo2" style="border:0px solid red;width: 106px;"><div class="rele_cso" style="color: red;">&nbsp;&nbsp;&nbsp;&nbsp;${ptu.ptotalprice }.00RMB(￥)</div></div></a>
	              ...
	              <div id="rele_oo6" style="border:0px solid red;width: 131px;"><div class="rele_cso" style="margin-top: 0px;">${ptu.ptimelimit}(小时)</div></div>
