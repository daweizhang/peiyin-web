...
public class EncryptionDecryption {
	 ...
	 * 默认密钥
	 */
	private static String strDefaultKey = "tandaly20131108";
	...
	public static void main(String[] args) {
		try{
            ...
            String mdjm=des.encrypt("123456");
            System.out.println("加密后的字符：" + mdjm);
            System.out.println("--------------------------------------------------------------");
            System.out.println("请输入要解密的密码：");
            String passrods=input.next();
            System.out.println("解密后的字符：" + des.decrypt(passrods));
        } catch (Exception e) {
            e.printStackTrace();
        }
	}
