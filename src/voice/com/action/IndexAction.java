...
public class IndexAction extends ActionSupport {
	 ...
	 * 查询主页的三个类型信息(中文)
	 */
	public String Indexfind() throws Exception {
		try {
	 ...
	 * 跳转排行榜
	 */
	public String rankinglists() throws Exception {
	 ...
	 * 跳转登录页面
	 */
	public String logincon() throws Exception {
	 ...
	 * 跳转交易流程
	 */
	public String jumpjylc() throws Exception {
	 ...
	 * 跳转费用与付款
	 */
	public String jumpfyfk() throws Exception {
	 ...
	 * 跳转常见问题
	 */
	public String jumpcjwt() throws Exception {
	 ...
	 * 跳转投诉与建议
	 */
	public String jumptsjy() throws Exception {
	 ...
	 * 跳转关于我们
	 */
	public String jumpgywm() throws Exception {
	 ...
	 * 查询主页的三个类型信息(英文)
	 */
	public String IndexfcEgl() throws Exception {
